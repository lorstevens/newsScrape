...
//  THIS IS THE GET ROUTE FOR SCRAPING THE ONION AND RENDERING TO THE PAGE
...
//GET  ROUTE FOR GETTING ALL ARTICLES AND RENDERING ON HOME PAGE
app.get('/', function(req,res){
  res.render('index');
});


//GET ROUTE FOR DISPLAYING ALL ARTICLES FROM JSON
