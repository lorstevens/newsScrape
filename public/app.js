...
// Grab the articles as a json PROB NOT NEEDED?
...
//GETTING THE ARTICLES AT A SPECIFIC ID
//ID IS NOT BEING LOGGED? WHYYYYY?
$(document).ready(function(){
    $(".save").on("click", function(){
        var thisId = $(this).attr("_id")
        console.log("working workin")
        console.log(thisId)
  $.ajax({
    method: "GET",
    url: "/articles/" + thisId
